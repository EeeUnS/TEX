...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{pic/section12/pit1}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{pic/section12/pit2}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{pic/section12/pit3.png}
    \caption{메모리 계층}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{pic/section12/pit4.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{pic/section12/pit5.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{pic/section12/pit6.png}
    \caption{context switching}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{pic/section12/pit7.png}
    \caption{Process virtual address space.}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{pic/section12/pit8.png}
    \caption{Using telnet to run hello remotely over a network.}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{pic/section12/pit9.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{pic/section12/pit10.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{pic/section12/pit11.png}
    \caption{ex endian}
\end{figure}
